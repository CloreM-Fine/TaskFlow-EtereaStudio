...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <!-- Riga 1: Personalizzazione (a tutta larghezza) -->
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-slate-600 mb-3">
                            Manuale completo per l'utilizzo di TaskFlow
                        </p>
                        <a href="istruzioni.php" target="_blank"
                           class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg transition-colors text-xs font-medium">
            ...
            <div class="p-4 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl border border-emerald-100">
                <div class="flex items-start gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-slate-600 mb-3">
                            GDPR, cookie policy e termini di servizio
                        </p>
                        <a href="sicurezza.php" target="_blank"
                           class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-colors text-xs font-medium">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                            </svg>
                            Apri documento
...
<!-- Grid principale ripreso per le sezioni successive -->
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
